...
export default function collection() {
  return (
    <section>
      <div className="grid grid-cols-1  md:grid-cols-3 gap-4 py-10 px-10 h-[90vh] md:h-[50vh]  text-black/80">
        {/* p 1 */}
        <div className="img-style w-[95%] collection__p1  relative">
        ...
        {/* p2 */}
        <div className="img-style w-[95%] collection__p2 relative">
        ...
        {/* p3 */}
        <div className="img-style w-[95%] collection__p3 relative">
